...
<body>
    ...
    <section class="base">
        ...
        <div>
            ...
            <img src="gambar/<?php echo $data['gambar_produk']; ?>" style="width: 120px;float: left;margin_bottom: 5px;">
            <input type="file" name="gambar_produk" />
            <i style="float: left;font-size: 11px;color: red;">Abaikan jika tidak merubah gambar produk</i>
        </div>
        <div>
            <br>
            <button style="border-radius: 32px;" type="submit">Simpan Perubahan</button>
        </div>
    </section>
    </form>
</body>
